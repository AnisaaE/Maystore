...
const categories = [
  ...
  },
  {
    ...
    text: "Получите облекло, което е точно толкова уникално, колкото сте и вие. Нашите персонализирани дрехи са идеалното решение за индивидуални клиенти, които търсят специален стил и дизайн. Създайте уникални облекла за специални случаи.",
    image: kidFather,
  },
];
